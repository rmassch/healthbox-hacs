...
1. In the `custom_components` directory (folder) create a new folder called `healthbox3`.
1. Download _all_ the files from the `custom_components/healthbox3/` directory (folder) in this repository.
